...
import { TechCursor } from './components/TechEffects';
...
const AppRoutes = () => {
  ...
  return <Routes>
      ...
      {/* Brand routes */}
      <Route path="/dashboard/brand" element={<ProtectedRoute requiredType="brand">
            <BrandDashboard />
          </ProtectedRoute>} />
      <Route path="/dashboard/brand/matches/:matchId" element={<ProtectedRoute requiredType="brand">
            <MatchDetails />
          </ProtectedRoute>} />
      {/* Organizer routes */}
      <Route path="/dashboard/organizer" element={<ProtectedRoute requiredType="organizer">
            <OrganizerDashboard />
          </ProtectedRoute>} />
      <Route path="/dashboard/organizer/matches/:matchId" element={<ProtectedRoute requiredType="organizer">
            <MatchDetails />
          </ProtectedRoute>} />
      {/* Shared dashboard routes */}
      <Route path="/dashboard/saved" element={<ProtectedRoute>
            <SavedItemsPage />
          </ProtectedRoute>} />
      <Route path="/dashboard/inspiration" element={<ProtectedRoute>
      ...
      <Route path="/dashboard/matches" element={<ProtectedRoute>
            <MatchesPage />
          </ProtectedRoute>} />
      {/* Admin routes */}
  ...
  return <BrowserRouter>
      <AuthProvider>
        <DraftProfileProvider>
          ...
          <HelpChat />
          <TechCursor />
          {typeof process !== 'undefined' && process.env?.NODE_ENV === 'development' && <RegistrationDebugHelper />}
        </DraftProfileProvider>
      </AuthProvider>
    </BrowserRouter>;
}