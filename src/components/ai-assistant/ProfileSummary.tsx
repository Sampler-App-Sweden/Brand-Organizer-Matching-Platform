...
export function ProfileSummary({ profile, role }: ProfileSummaryProps) {
  const [isExpanded, setIsExpanded] = useState(false)
  const [isEditing, setIsEditing] = useState(false)
  const [editedProfile, setEditedProfile] = useState<DraftProfile | null>(
    profile
  )
  ...
  return (
    <div className='bg-white rounded-lg border border-gray-200 overflow-hidden'>
      ...
      <div className='p-4'>
            ...
            <div key={field.key} className='flex flex-col'>
              ...
              {isEditing ? (
                <input
                  ...
                  value={
                    (editedProfile?.[
                      field.key as keyof DraftProfile
                    ] as string) || ''
                  }
                ...
                <div className='text-sm text-gray-800'>
                  {profile[field.key as keyof DraftProfile] || (
        ...
        {!isExpanded && fields.length > collapsedFields.length && (
