...
export function Navbar({ transparent = false }: NavbarProps) {
  ...
  return (
    <nav className='bg-white bg-opacity-90 backdrop-blur-sm shadow-sm border-b border-gray-100 relative z-30'>
      <div className='container mx-auto px-4'>
        <div className='flex justify-between items-center h-16'>
          ...
          <div className='hidden md:flex items-center space-x-4'>
            <Link
              to='/community'
              className='px-3 py-2 rounded-md text-sm font-medium text-gray-700 hover:text-blue-600 transition-colors flex items-center relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-blue-600 after:transition-all hover:after:w-full'
            >
