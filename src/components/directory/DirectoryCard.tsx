...
export function DirectoryCard({ profile }: DirectoryCardProps) {
  ...
  return (
    <div className='bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100 hover:shadow-md hover:border-indigo-100 transition-all'>
      <div className='p-6'>
        ...
        <div className='mt-4 border-t border-gray-100 pt-4 space-y-3'>
          ...
          <div className='flex items-center justify-between text-sm text-gray-700'>
            ...
            <span>{profile.whatTheySeek?.budgetRange || 'Not specified'}</span>
          </div>
