...
import { TechBackground, TechGrid, TechParticles, TechGlow } from './TechEffects';
  ...
  return <div className="min-h-screen flex flex-col bg-gray-50 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        <div className="sticky top-0 left-0 right-0 z-50">
          ...
          {location.pathname.includes('/dashboard') && <div className="bg-white border-b border-gray-200 py-2 bg-opacity-90 backdrop-blur-sm">
          ...
          <div className="container mx-auto px-4 text-center md:text-left">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex space-x-6">
                <a href="/about" className="text-sm text-gray-500 hover:text-blue-600 transition-colors">
                  About
                </a>
