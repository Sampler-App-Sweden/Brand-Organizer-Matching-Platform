              ...
              {step === 3 && (
                <div className='space-y-4'>
                  <FormField
                    ...
                    placeholder={
                      currentUser?.type === 'brand'
                        ? `I'd love to provide samples of our products at your upcoming event...`
                        : `We're interested in featuring your products at our upcoming event...`
                    }
                  />
                  <div className='flex justify-between mt-6'>
                    <Button variant='outline' onClick={prevStep}>
