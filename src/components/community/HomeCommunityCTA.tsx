...
export function HomeCommunityCTA() {
  return <div className="bg-gradient-to-r from-indigo-50 to-purple-50 py-8 rounded-lg relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <Link to="/community">
            <Button variant="outline" className="flex items-center group transition-all hover:bg-indigo-50">
